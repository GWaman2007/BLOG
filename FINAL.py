...
def click_checkinn():
    call(["python", "2. check_in_gui.py"])

def click_list():
    call(["python", "3. show_guest_list_gui.py"])

def click_checkout():
    call(["python", "4. check_out_gui.py"])

def click_getinfo():
    call(["python", "5. get_info_gui.py"])
class MOTEL_MANAGEMENT:
    def __init__(self):
        root = Tk()
        _bgcolor = '#d3d3d3'  #Light grey
        _fgcolor = '#000000'  #Black text color
        _compcolor = '#ffffff' #White for components
        _ana1color = '#ffffff' # White color
        _ana2color = '#ffffff' # White color
        ...
        root.title("Motel Management System")
        root.configure(bg=_bgcolor)  #Set bg to grey
        root.configure(highlightbackground="#d9d9d9")
        root.configure(highlightcolor="black")

        self.menubar = Menu(root, font=font14, bg=_bgcolor, fg=_fgcolor)
        ...
        self.Frame1.configure(bg=_bgcolor) #Set frame bg grey
        ...
        self.Message6.configure(bg=_bgcolor) #Set bg to grey
        self.Message6.configure(highlightbackground="#d9d9d9")
        self.Message6.configure(highlightcolor="black")
        self.Message6.configure(text='''🛎☏🛏 InnSync 🏘✈🗺''')
        self.Message6.configure(width=791)

        #Adding title below the main title in smaller font
        self.Message7 = Message(self.Frame1)
        self.Message7.place(relx=0.09, rely=0.17, relheight=0.05, relwidth=0.86)
        self.Message7.configure(font=font12)
        self.Message7.configure(foreground="#000000")
        self.Message7.configure(bg=_bgcolor)  #Set bg to grey
        self.Message7.configure(text='''MOTEL MANAGEMENT SYSTEM''')
        self.Message7.configure(width=791)

        #Check-In Button
        self.Button2 = Button(self.Frame1, font=font14, foreground="#000000", text="1. CHECK IN", command=click_checkinn)
        self.Button2.place(relx=0.5, rely=0.3, anchor="center", height=80, width=566)

        #Show Guest List Button
        self.Button3 = Button(self.Frame1, font=font14, foreground="#000000", text="2. SHOW GUEST LIST", command=click_list)
        self.Button3.place(relx=0.5, rely=0.42, anchor="center", height=80, width=566)
        
          #Check-Out Button
        self.Button4 = Button(self.Frame1, font=font14, foreground="#000000", text="3. CHECK OUT", command=click_checkout)
        self.Button4.place(relx=0.5, rely=0.54, anchor="center", height=80, width=566)

        #Get Guest Info Button
        self.Button5 = Button(self.Frame1, font=font14, foreground="#000000", text="4. GET INFO OF ANY GUEST", command=click_getinfo)
        self.Button5.place(relx=0.5, rely=0.66, anchor="center", height=80, width=566)

        #Exit Button
        self.Button6 = Button(self.Frame1, font=font14, foreground="#000000", text="5. EXIT", command=quit)
        self.Button6.place(relx=0.5, rely=0.78, anchor="center", height=80, width=566)

        root.mainloop()

if __name__ == '__main__':
    GUUEST = MOTEL_MANAGEMENT()
...
class New_Toplevel:
    ...
    def __init__(self):
        ...
        '''This class configures and populates the toplevel window.
           top is the toplevel containing window.'''
        _bgcolor = '#d3d3d3'  #Light grey color
        _fgcolor = '#000000'  #X11 color: 'black'
        _compcolor = '#d3d3d3' #Light grey
        _ana1color = '#d3d3d3' #Light grey
        _ana2color = '#d3d3d3' #Light grey
        font10 = "-family {Courier New} -size 10 -weight normal -slant"  \
            " roman -underline 0 -overstrike 0"
